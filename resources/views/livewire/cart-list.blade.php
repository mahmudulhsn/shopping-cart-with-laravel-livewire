<div>
    <div>
            ...
            <table class="w-full text-center">
                ...
                <tbody>
                  ...
                  <tr class="bg-white-100 shadow-lg rounded-md">
                    ...
                    <td class="py-5"><span class="text-red-800 text-xl font-bold cursor-pointer">X</span></td>
                  </tr>
                  @endforeach
                </tbody>
        ...
        @else
            <h2 class="text-2xl font-bold text-center text-blue-600">Your Cart is empty! Please buy bomething!</h2>
        @endif
